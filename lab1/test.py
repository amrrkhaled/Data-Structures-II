...
def main():
    ...
    for size in sizes:
        ...
        print(f"Array Size: {size}, Bubble Sort Time: {bubble_time:.3f} ms, Selection Sort Time: {selection_time:.3f} ms")
    ...
    plt.title("Bubble Sort vs Selection Sort Execution Time (ms)")
    plt.legend()
    plt.grid(True)
    plt.show()
